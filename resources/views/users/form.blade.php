        ...
        <div
            ...
            <form method="POST" action="{{ $meta_page['url'] }}">
                ...
                <div>
                    ...
                    <x-text-input id="name" :value="old('name', $user->name)" class="block mt-1 w-full" type="text" name="name"
                ...
                <div>
                    ...
                    <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                        placeholder="User email" :value="old('email', $user->email)" required autofocus autocomplete="username" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required
                        placeholder="********" :value="old('password', $user->password)" autocomplete="current-password" />
