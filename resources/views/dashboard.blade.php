<x-app-layout>
    <div x-data="{ content: 'Overview' }" class="antialiased">
        <div class="p-4 md:ml-64 h-auto pt-20">
            ...
            <x-sidebar>
                <li>
                    <button @click.prevent="content = 'Overview'"
                        class="flex items-center p-2 text-base w-full font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
